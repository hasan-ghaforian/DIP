...
range of logarithmic transformation is greater than or equal to the ratio of size of input to the size of input domain. So we can say the output is wider in 
its domain. And also we see that the intensity of output will be greater in its
...
leads us to the second prospect which is related to \emph{Octave lab}
...
The other prospect is relative to the way that a matrix be interpreted as an
